...
Sprite.prototype.initialize = function() {
    ...
    app.mouse.on('mouseup', this.offMouseDown, this);
...
Sprite.prototype.offMouseDown = function (e) {
    if (!this.eventsEnabled) {
        return;
    }
...
Sprite.prototype.offTouchDown = function (e) {
    if (!this.eventsEnabled) {
        return;
    }

    this.offClick(e.changedTouches[0]);
};
 ...
 * sprite and fires 'click' event if it has
 */
Sprite.prototype.offClick = function (cursor) {
    var canvas = this.app.graphicsDevice.canvas;
    var tlx, tly, brx, bry, mx, my;
...
Sprite.prototype.update = function (dt,cursor) {
